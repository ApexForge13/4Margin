...
function Logo() {
  return (
    <span className="text-xl font-bold tracking-tight">
      <span className="text-[#3B8EF7]">4</span>
...
function SectionTag({ children }: { children: React.ReactNode }) {
  return (
    <span className="inline-block rounded-full border border-[#3B8EF7]/20 bg-[#3B8EF7]/5 px-4 py-1.5 text-xs font-semibold uppercase tracking-widest text-[#3B8EF7]">
      {children}
    </span>
  );
}
  ...
  return (
    <div className="min-h-screen bg-[#060A13] text-white antialiased">
      ...
      <nav className="sticky top-0 z-50 border-b border-white/5 bg-[#060A13]/80 backdrop-blur-xl">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/signup"
              className="rounded-lg bg-[#3B8EF7] px-5 py-2.5 text-sm font-semibold text-white shadow-lg shadow-[#3B8EF7]/20 transition hover:bg-[#2B7DE6] hover:shadow-[#3B8EF7]/30"
            >
              Get Started Free
            </Link>
          </div>
      ...
      <section className="relative overflow-hidden">
        {/* Gradient orbs */}
        <div className="pointer-events-none absolute -top-40 left-1/2 h-[600px] w-[900px] -translate-x-1/2 rounded-full bg-[#3B8EF7]/8 blur-[120px]" />
        <div className="pointer-events-none absolute top-20 right-0 h-[400px] w-[400px] rounded-full bg-[#3B8EF7]/5 blur-[100px]" />
        ...
        <div className="relative mx-auto max-w-4xl px-6 pt-24 pb-20 text-center sm:pt-32 sm:pb-28">
          ...
          <h1 className="text-4xl font-extrabold leading-[1.1] tracking-tight sm:text-5xl md:text-6xl">
            Stop leaving{" "}
            <span className="bg-gradient-to-r from-[#3B8EF7] to-[#60B0FF] bg-clip-text text-transparent">
              $3,000–$8,000
            </span>{" "}
          ...
          <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <Link
              href="/signup"
              className="w-full rounded-xl bg-[#3B8EF7] px-8 py-4 text-center text-base font-bold text-white shadow-lg shadow-[#3B8EF7]/25 transition hover:bg-[#2B7DE6] hover:shadow-xl hover:shadow-[#3B8EF7]/30 sm:w-auto"
            >
          ...
          <div className="mt-16 grid grid-cols-3 gap-6 border-t border-white/5 pt-10">
            {[
              { value: "$4,200", label: "Avg. recovery per supplement" },
              { value: "< 10 min", label: "From upload to download" },
              { value: "$149", label: "Per supplement — pay as you go" },
            ].map((stat) => (
              <div key={stat.label}>
        ...
        <div className="mx-auto max-w-5xl px-6 py-24 sm:py-32">
          ...
          <div className="mt-16 grid gap-8 md:grid-cols-3">
            {[
              ...
              <div
                key={item.step}
                className="group relative rounded-2xl border border-white/5 bg-white/[0.02] p-8 transition hover:border-[#3B8EF7]/20 hover:bg-[#3B8EF7]/[0.03]"
              >
                <div className="mb-4 flex items-center gap-3">
                  <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-[#3B8EF7]/10 text-[#3B8EF7] transition group-hover:bg-[#3B8EF7]/20">
                    {item.icon}
                  </div>
                  <span className="font-mono text-sm font-bold text-[#3B8EF7]/40">
                    {item.step}
                  </span>
                </div>
      ...
      <section className="border-t border-white/5 bg-[#080D18]">
        <div className="mx-auto max-w-5xl px-6 py-24 sm:py-32">
          <div className="rounded-2xl border border-[#3B8EF7]/10 bg-gradient-to-br from-[#3B8EF7]/5 to-transparent p-10 sm:p-16">
            <div className="text-center">
            ...
            <div className="mt-12 grid gap-8 sm:grid-cols-3">
              {[
                ...
                <div key={s.label} className="text-center">
                  <div className="text-3xl font-extrabold text-[#3B8EF7] sm:text-4xl">
                    {s.value}
                  </div>
        ...
        <div className="mx-auto max-w-5xl px-6 py-24 sm:py-32">
          ...
          <div className="mt-14 grid gap-6 sm:grid-cols-2">
            {[
              ...
              >
                <div className="mb-2 flex h-8 w-8 items-center justify-center rounded-lg bg-[#3B8EF7]/10">
                  <svg className="h-4 w-4 text-[#3B8EF7]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section id="pricing" className="border-t border-white/5 bg-[#080D18]">
        <div className="mx-auto max-w-3xl px-6 py-24 sm:py-32">
          ...
          <div className="mt-12 rounded-2xl border border-[#3B8EF7]/20 bg-gradient-to-b from-[#3B8EF7]/5 to-transparent p-8 text-center sm:p-12">
            ...
            <ul className="mx-auto mt-8 max-w-sm space-y-3 text-left text-sm">
              {[
                ...
                <li key={item} className="flex items-start gap-3">
                  <svg className="mt-0.5 h-5 w-5 shrink-0 text-[#3B8EF7]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
            ...
            <Link
              href="/signup"
              className="mt-10 inline-block rounded-xl bg-[#3B8EF7] px-10 py-4 text-base font-bold text-white shadow-lg shadow-[#3B8EF7]/25 transition hover:bg-[#2B7DE6] hover:shadow-xl hover:shadow-[#3B8EF7]/30"
            >
      ...
      <section className="border-t border-white/5">
        <div className="mx-auto max-w-3xl px-6 py-24 text-center sm:py-32">
          ...
          <Link
            href="/signup"
            className="mt-8 inline-block rounded-xl bg-[#3B8EF7] px-10 py-4 text-base font-bold text-white shadow-lg shadow-[#3B8EF7]/25 transition hover:bg-[#2B7DE6] hover:shadow-xl hover:shadow-[#3B8EF7]/30"
          >
            Start Your First Supplement Free
          </Link>
        </div>
